...
As explained in my other post  [PE File Structures](https://blog.adriapt.com/posts/PEfiles/), all PE’s start with `MZ` (`0x5A4D`). So the `ReflectiveLoader` will go backwards until it finds this: 
